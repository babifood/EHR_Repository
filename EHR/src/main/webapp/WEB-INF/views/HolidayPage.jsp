	...
	<div id="holiday_menu" class="easyui-tabs" data-options="fit:true">
		<div title="节假日管理" id="calendar"style="float: none; margin: 0px auto;">
			<div class="main" style="height: 98%;">
				...
				<div id="myrl" style="width: 920px; margin-left: auto; margin-right: auto; height: 840px; overflow: hidden;">
					<form name=CLD>
						<TABLE class="biao" style="table-layout: fixed" width="900px">
							<TBODY id="calendar-table">
								<TR>
									<TD class="calTit" colSpan=7
										style="height: 30px; padding-top: 3px; text-align: center;">

										<a href="#" title="上一年" id="nianjian"
										class="ymNaviBtn lsArrow"></a> <a href="#" title="上一月"
										id="yuejian" class="ymNaviBtn lArrow"></a>
										...
										<div style="width: 250px; float: left; padding-left: 230px;">
											<span id="dateSelectionRili" class="dateSelectionRili"
												...
												id="yue" class="topDateFont"></span><span
												class="topDateFont">月</span> <span
												class="dateSelectionBtn cal_next"
												...
												<div id="monthList">
													<div id="monthListContent">
														<span id="SM0" class="month"
															...
															id="SM1" class="month"
															onclick="dateSelection.setMonth(1)">2</span><span
															id="SM2" class="month"
															onclick="dateSelection.setMonth(2)">3</span><span
															id="SM3" class="month"
															onclick="dateSelection.setMonth(3)">4</span><span
															id="SM4" class="month"
															onclick="dateSelection.setMonth(4)">5</span><span
															id="SM5" class="month"
															onclick="dateSelection.setMonth(5)">6</span><span
															id="SM6" class="month"
															onclick="dateSelection.setMonth(6)">7</span><span
															id="SM7" class="month"
															onclick="dateSelection.setMonth(7)">8</span><span
															id="SM8" class="month"
										...
										</div> <a href="#" id="nianjia" title="下一年"
										class="ymNaviBtn rsArrow" style="float: right;"></a> <a
										href="#" id="yuejia" title="下一月" class="ymNaviBtn rArrow"
										style="float: right;"></a> <!--	<a id="jintian" href="#" title="今天" class="btn" style="float:right; margin-top:-2px; font-size:12px; text-align:center;">今天</a>-->
								...
								<SCRIPT language="JavaScript">
									...
									for (var i = 0; i < 6; i++) {
										...
										tr.style = "table-layout:fixed;height:45px";
										tr.align = "center";
										// 						tr.height="50";
// 										tr.id = "tt";
										for (var j = 0; j < 7; j++) {
