...
public interface PersonInFoDao {
	...
	public Integer getPersonCount(String date, String resourceCode);

	public List<Map<String, Object>> findPagePersonInfo(int startIndex, int pageSize, String date,String resourceCode);
