...
public class PersonInFoDaoImpl implements PersonInFoDao {
	...
	public void savePersonInfo(PersonBasrcEntity personInFo) throws DataAccessException{
		...
		Object[] sql_insert_basrc_params=new Object[83];
		...
		sql_insert_basrc_params[50]=personInFo.getP_company_age();
		sql_insert_basrc_params[51]=personInFo.getP_c_yingpin_table();
		sql_insert_basrc_params[52]=personInFo.getP_c_interview_tab();
		sql_insert_basrc_params[53]=personInFo.getP_c_id_copies();
		sql_insert_basrc_params[54]=personInFo.getP_c_xueli();
		sql_insert_basrc_params[55]=personInFo.getP_c_xuewei();
		sql_insert_basrc_params[56]=personInFo.getP_c_bank_nub();
		sql_insert_basrc_params[57]=personInFo.getP_c_tijian_tab();
		sql_insert_basrc_params[58]=personInFo.getP_c_health();
		sql_insert_basrc_params[59]=personInFo.getP_c_img();
		sql_insert_basrc_params[60]=personInFo.getP_c_welcome();
		sql_insert_basrc_params[61]=personInFo.getP_c_staff();
		sql_insert_basrc_params[62]=personInFo.getP_c_admin();
		sql_insert_basrc_params[63]=personInFo.getP_c_shebao();
		sql_insert_basrc_params[64]=personInFo.getP_c_shangbao();
		sql_insert_basrc_params[65]=personInFo.getP_c_secrecy();
		sql_insert_basrc_params[66]=personInFo.getP_c_prohibida();
		sql_insert_basrc_params[67]=personInFo.getP_c_contract();
		sql_insert_basrc_params[68]=personInFo.getP_c_post();
		sql_insert_basrc_params[69]=personInFo.getP_c_corruption();
		sql_insert_basrc_params[70]=personInFo.getP_c_probation();
		sql_insert_basrc_params[71]=personInFo.getP_create_date();
		sql_insert_basrc_params[72]=personInFo.getP_this_dept_code();
		sql_insert_basrc_params[73]=personInFo.getP_id_num();
		sql_insert_basrc_params[74]=personInFo.getP_birthday();
		sql_insert_basrc_params[75]=personInFo.getP_use_work_form();
		sql_insert_basrc_params[76]=personInFo.getP_contract_count();
		sql_insert_basrc_params[77]=personInFo.getP_oa_and_ehr();
		sql_insert_basrc_params[78]=personInFo.getP_huji();
		sql_insert_basrc_params[79]=personInFo.getP_hukou_xingzhi();
		sql_insert_basrc_params[80]=personInFo.getP_age_qujian();
		sql_insert_basrc_params[81]=personInFo.getP_zuigao_xueli();
		sql_insert_basrc_params[82]=personInFo.getP_recommend_person();
		//教育背景
