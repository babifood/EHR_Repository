...
public class BaseFieldsEntity {
	...
	private String performanceScore;//绩效分值
	
	private String performanceSalary;//绩效工资
	
	private String realSalary;//实际绩效奖金
	...
	private String completionHours;//旷工时间
	
	private String onboardingHours;//月中入离职时间
...
//	private String piming;//计时
	...
	public String getSickGrandHours() {
		return sickGrandHours;
	}

	public void setSickGrandHours(String sickGrandHours) {
		this.sickGrandHours = sickGrandHours;
	}
	...
	public void setSickHours(String sickHours) {
	...
	public void setParentalHours(String parentalHours) {
		this.parentalHours = parentalHours;
	}
	...
	public String getOnboardingHours() {
		return onboardingHours;
	}

	public void setOnboardingHours(String onboardingHours) {
		this.onboardingHours = onboardingHours;
	}

	public String getThingHours() {
		return thingHours;
	}
