...
public class BasicSalaryDetailServiceImpl implements BasicSalaryDetailService {
	...
	private Map<String, String> getRow1Name() {
		...
		row1Name.put("年假", "yearDeduction");
		row1Name.put("调休", "relaxation");
		row1Name.put("事假", "thingDeduction");
		row1Name.put("病假", "sickDeduction");
		row1Name.put("培训假", "trainDeduction");
		row1Name.put("产假", "parentalDeduction");
		row1Name.put("婚假", "marriageDeduction");
		row1Name.put("陪产假", "companionParentalDeduction");
		row1Name.put("丧假", "funeralDeduction");
		row1Name.put("月中入职、离职", "onboarding");
